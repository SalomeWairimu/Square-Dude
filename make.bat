...
link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj spongebob.obj plankton.obj krustykrab.obj patty.obj libgame.obj
